...
const Home = () => {
  ...
  useEffect(() => {
    if (!backgroundBtn) dispatch(setSwitchBackgroundOff());
    if (backgroundBtn) dispatch(setSwitchBackgroundOn());
  }, [dispatch, backgroundBtn]);
    ...
    <BackgroundSlider>
      ...
      >
        ...
        >
          ...
          <div
            className={
              switchBackground ? filtersContainer : filtersContainerOff
            }
          >
            <SearchFilter
              icon={faGlobeEurope}
        ...
        <div
          className={switchBackground ? textContainerOverlayOn : textContainer}
        >
